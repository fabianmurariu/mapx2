...
fn main() {
    ...
    for size in test_sizes {
        ...
        if double_total.as_nanos() > 0 {
            println!("  Total time: {:.2}x", single_total.as_nanos() as f64 / double_total.as_nanos() as f64);
        }
        if double_max_insert.as_nanos() > 0 {
